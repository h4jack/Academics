// implementation of DIJKSTRA PRINCIPLE using c++
#include <limits.h>
#include <stdio.h> 
#include <stdbool.h>
#define V 9 // Number of vertices in the graph
int minDistance(int dist[], bool sptSet[]) /* A utility function to find the vertex with minimum 
distance value, from the set of vertices not yet included in shortest path tree */
{
